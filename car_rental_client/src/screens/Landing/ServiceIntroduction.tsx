    ...
    return (
        <div className="w-full h-auto float-left overflow-auto grid grid-cols-1">
            <div className="w-full h-auto py-6 px-2 lg:px-28">
                ...
                <div className="lg:mx-20 px-4 py-8 lg:p-8 my-6 rounded-xl bg-gray-light overflow-auto">
                    <BookingSearch />
                </div>
            </div>
            <div className="w-full min-h-96 h-auto py-6">
                <div className="w-full h-auto py-6 float-left overflow-auto grid grid-cols-1 lg:grid-cols-3 gap-8 place-items-center lg:px-28">
