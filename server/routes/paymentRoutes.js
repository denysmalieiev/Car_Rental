...
// Order routes
router.route('/new').post(authToken.isUserAuthenticated, carRental_User_Order_Creation);
router.route('/all').get(authToken.isUserAuthenticated, carRental_User_All_Orders);
router.route('/:id').get(authToken.isUserAuthenticated, carRental_User_Single_Order);
